<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ejercicio2.aspx.cs" Inherits="tp6_prog3.Ejercicio2.Inicio" %>
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style3">&nbsp;</td>
                    <td>
                        <asp:LinkButton ID="lbtnEliminarProductos" runat="server" OnClick="lbtnEliminarProductos_Click">Eliminar Productos seleccionados</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style4">&nbsp;</td>
